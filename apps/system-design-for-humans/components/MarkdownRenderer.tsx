...
import { MarkdownRenderer as BaseMarkdownRenderer, type BaseSegment } from '@for-humans/ui'
...
interface Props {
  content: string
  className?: string
  /** Single prompt used for all evaluators (scenarios), or per-evaluator array (fundamentals) */
