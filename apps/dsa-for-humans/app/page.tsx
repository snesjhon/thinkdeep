...
import { CodeEditorMockup } from '@/components/homepage/CodeEditorMockup';
import { TracerMockup } from '@/components/homepage/TracerMockup';
import { MentalModelMockup } from '@/components/homepage/MentalModelMockup';
    ...
    <>
      ...
      <section className="bg-[var(--bg)]">
        <div className="max-w-[1152px] mx-auto px-6 pt-[72px] pb-[80px]">
          ...
          {/* Feature 1 — Tracer */}
          <div
            className="grid gap-x-14 gap-y-10 mb-10 items-center grid-cols-[1.1fr_0.9fr]"
          >
            <TracerMockup />
            <div>
