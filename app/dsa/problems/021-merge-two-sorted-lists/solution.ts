...
function mergeTwoLists(list1: ListNode | null, list2: ListNode | null): ListNode | null {
  ...
  // Coupling loop — runs while both trains have cars to offer
  ...
  // Hitch the remaining train — it's already sorted, one assignment chains it all
...
test('list1 entirely smaller', () => listToArray(mergeTwoLists(createList([1, 2, 3]), createList([5]))), [1, 2, 3, 5]);
