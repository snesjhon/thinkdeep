// =============================================================================
// Maximum Average Subarray I — Step 1 of 2: Warm the Spotlight — SOLUTION
// =============================================================================
...
function findMaxAverage(nums: number[], k: number): number {
  let spotlightSum = 0;
  for (let i = 0; i < k; i++) {
    spotlightSum += nums[i]; // each performer enters the spotlight
  }
  const bestSpotlight = spotlightSum; // first window is the first candidate
  return bestSpotlight / k;           // convert total score to average score
}
