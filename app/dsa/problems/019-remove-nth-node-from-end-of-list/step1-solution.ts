// =============================================================================
// Remove Nth Node From End of List — Step 1 of 2: The Platform Marker and the Scout Gap — SOLUTION
// =============================================================================
...
function removeNthFromEnd(head: ListNode | null, n: number): ListNode | null {
  ...
  const remover: ListNode = platform;

  // Scout gap — walk n + 1 steps so the remover stands before the target connector
  for (let gapStep = 0; gapStep <= n; gapStep += 1) {
    scout = scout!.next;
  }

  // Step 1 only handles head removal, where the remover is still on the platform
