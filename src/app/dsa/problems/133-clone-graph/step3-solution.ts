// Goal: Wrap the DFS city-copy helper in the real problem contract. Return
// null for an empty city, otherwise clone the connected graph from the entry node.
